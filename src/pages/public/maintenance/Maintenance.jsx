...
const STYLES = `
  ...
  .four-o-four {
    ...
    -webkit-text-fill-color: #00e5f0;
    text-shadow:
      0 0 20px rgba(0, 229, 240, 0.55),
      0 0 48px rgba(0, 200, 212, 0.35);
  ...
  .kamui-btn:hover { color: #050d12 !important; border-color: #00e5f0; }
  ...
  return (
    <>
      ...
      <div className="kamui-root">
        ...
        {/* Orbiting text */}
        <div style={{ position:"absolute", top:"50%", left:"50%", zIndex:2, pointerEvents:"none" }}>
          <span className="dimension-text">ZEPHYR · MAINTENANCE PROTOCOL · メンテナンス · SYSTEM HOLD</span>
        </div>

        {/* Content */}
        <div className="kamui-content">
          <div className="brand-tag">Zephyr · Maintenance Mode</div>
          ...
          <div className="error-tag">
            ...
            <span className="error-tag-text">HTTP 503 · TEMPORARILY OFFLINE</span>
          </div>

          <div className="four-o-four">503</div>
          <p className="subtitle">Systems Undergoing Calibration</p>
          ...
          <p className="kamui-body">
            {message?.trim()
              ...
              : (
                <>
                  We&apos;re upgrading the Zephyr systems for a smoother experience.
                  <br />
          ...
          <a className="kamui-btn" href="/login">
            ← Staff Access
          </a>
        </div>
      </div>
